import {getData, URL} from './server/index.js';
import {Mode, renderInactiveInterface} from './render-page/index.js';
import {renderMap} from './map/index.js';

/*
TODO 1. Доработать модуль для отрисовки меток на карте так, чтобы в качестве данных использовались
        не случайно сгенерированные объекты, а те данные, которые вы загрузите с сервера.
